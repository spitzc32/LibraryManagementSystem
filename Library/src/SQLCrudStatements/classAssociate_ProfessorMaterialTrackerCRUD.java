...
public class classAssociate_ProfessorMaterialTrackerCRUD {
	...
	public static classEntity funcRetrieveDisplayEntityAPMTObj (String table, int id) {
	...
	public static classObject funcRetrieveDisplayObjectAPMTObj (String table, int id) {
